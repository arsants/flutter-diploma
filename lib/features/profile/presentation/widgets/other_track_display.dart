...
class OtherTrackDisplayWidget extends StatefulWidget {
  final String username;

  const OtherTrackDisplayWidget({Key? key, required this.username})
      : super(key: key);

  @override
  _OtherTrackDisplayWidgetState createState() =>
      _OtherTrackDisplayWidgetState();
}

class _OtherTrackDisplayWidgetState extends State<OtherTrackDisplayWidget>
  ...
  Future<void> getTrack() async {
    await context.read<OtherTrackCubit>().get(widget.username,
        times[_tabController.index], filterList[_selectedFilter]);
  }
          ...
          body: TabBarView(
            ...
            children: [
              BlocListener<RideCubit, RideState>(
                ...
                child: BlocConsumer<OtherTrackCubit, TrackState>(
